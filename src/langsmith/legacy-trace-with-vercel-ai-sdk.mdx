...
<Warning>
  This page documents an older method of tracing AI SDK runs. For a simpler and more general method that directly uses OpenTelemetry (OTEL), see [the new guide](/langsmith/trace-with-vercel-ai-sdk).
</Warning>
