---
title: Filter traces in the application
sidebarTitle: Filter traces in the application
---

<Tip>**Recommended reading**: It might be helpful to read the [Conceptual guide on tracing](/langsmith/observability-overview) to gain familiarity with the concepts mentioned on this page.</Tip>
