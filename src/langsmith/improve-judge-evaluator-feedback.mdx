...
<Check>
  ...
  * [Evaluation concepts](/langsmith/evaluation-overview#evaluators)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| In order to get started, you need a [dataset](/langsmith/evaluation-overview#datasets) with at least one [experiment](/langsmith/evaluation-overview#experiment) You'll need to upload or create datasets via the [SDK](/langsmith/manage-datasets-programmatically#create-a-dataset) or the [UI](/langsmith/manage-datasets-in-application#set-up-your-dataset) and run an experiment via the [SDK](/langsmith/evaluate-llm-application#run-the-evaluation) or the [Playground](/langsmith/run-evaluation-from-prompt-playground#5-run-your-evaluation) | In order to get started, you need an application that’s already sending traces to LangSmith. Configure one of our [tracing integrations](/langsmith/observability-overview#integrations) to start |
...
Select one or more experiments (or runs) to send for human labeling. This will add runs to an [annotation queue](/langsmith/evaluation-overview#annotation-queues).
