...
* [**Datasets**:](/langsmith/evaluation-overview#datasets) Collections of test inputs and reference outputs.
* [**Evaluators**](/langsmith/evaluation-overview#evaluators): Functions for scoring outputs.
...
* [Example](/langsmith/evaluation-overview#examples): The example(s) from your [Dataset](/langsmith/evaluation-overview#datasets). Contains inputs, (reference) outputs, and metadata.
* [Run](/langsmith/observability-overview#runs): The actual outputs and intermediate steps (child runs) from passing the example inputs to the application.
...
You can run evaluators using the LangSmith SDK ([Python](https://docs.smith.langchain.com/reference/python) and [TypeScript](https://docs.smith.langchain.com/reference/js)), via the [Prompt Playground](/langsmith/observability-overview#prompt-playground), or by configuring [Rules](/langsmith/rules) to automatically run them on particular tracing projects or datasets.
...
LangSmith's [annotation queues](/langsmith/evaluation-overview#annotation-queues) make it easy to get human feedback on your application's outputs.
...
You can run offline evaluations client-side using the LangSmith SDK ([Python](https://docs.smith.langchain.com/reference/python) and [TypeScript](https://docs.smith.langchain.com/reference/js)). You can run them server-side via the [Prompt Playground](/langsmith/observability-overview#prompt-playground) or by configuring [automations](/langsmith/rules) to run certain evaluators on every new experiment against a specific dataset.
