---
title: How to rename an experiment
sidebarTitle: Rename an experiment
---
...
You can rename an experiment immediately after running it by editing its name in the Playground table header. ![Edit name in playground](/langsmith/images/rename-in-playground.png)
