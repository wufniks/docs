...
- Running [online evaluations](/langsmith/evaluation-overview#online-evaluation)
...
- **[LLM-as-a-judge](/langsmith/evaluation-overview#llm-as-judge)**: Use an LLM to evaluate your traces. Used as a scalable way to provide human-like judgement to your output (e.g. toxicity, hallucination, correctness, etc.).
