...
![](/langsmith/images/compare-select.png)
...
![](/langsmith/images/toggle-views.gif)
...
![Regressions](/langsmith/images/regression-view.png)
...
![Regressions Filter](/langsmith/images/filter-to-regressions.png)
...
![Baseline](/langsmith/images/select-baseline.png)

## Open a trace

If the example you're evaluating is from an ingested [run](/langsmith/observability-overview#runs), you can hover over the output cell and click on the trace icon to open the trace view for that run. This will open up a trace in the side panel.

![](/langsmith/images/open-source-trace.png)
...
![](/langsmith/images/metadata-in-charts.png)
