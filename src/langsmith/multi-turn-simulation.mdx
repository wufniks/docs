...
<Info>
  * [Multi-turn interactions](/langsmith/evaluation-overview#multi-turn-interactions)
  * [Evaluators](/langsmith/evaluation-overview#evaluators)
  * [LLM-as-judge](/langsmith/evaluation-overview#llm-as-judge)
  * [OpenEvals](https://github.com/langchain-ai/openevals)
</Info>

AI applications with conversational interfaces, like chatbots, operate over multiple interactions with a user, also called conversation *turns*. When evaluating the performance of such applications, core concepts such as [building a dataset](/langsmith/evaluation-overview#datasets) and defining [evaluators](/langsmith/evaluation-overview#evaluators) and metrics to judge your app outputs remain useful. However, you may also find it useful to run a *simulation* between your app and a user, then evaluate this dynamically created trajectory.
