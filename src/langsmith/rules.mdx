...
- **Add to dataset**: Add the inputs and outputs of the trace to a [dataset](/langsmith/evaluation-overview#datasets).
- **Add to annotation queue**: Add the trace to an [annotation queue](/langsmith/evaluation-overview#annotation-queues).
