...
LangGraph provides the [**time travel**](/oss/langgraph/time-travel) functionality to resume execution from a prior checkpoint, either replaying the same state or modifying it to explore alternatives. In all cases, resuming past execution produces a new fork in the history.
...
* [**LangGraph time travel guide**](/oss/langgraph/time-travel): learn more about using time travel in LangGraph.
