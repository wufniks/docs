...
Currently, LangGraph only addresses this as part of [LangGraph Platform](index), not in the open source.
...
![](img/double-texting.png)

## Reject

This is the simplest option, this just rejects any follow-up runs and does not allow double texting.
See the [how-to guide](reject-concurrent) for configuring the reject double text option.
...
See the [how-to guide](enqueue-concurrent) for configuring the enqueue double text option.
...
See the [how-to guide](interrupt-concurrent) for configuring the interrupt double text option.
...
See the [how-to guide](rollback-concurrent) for configuring the rollback double text option.
