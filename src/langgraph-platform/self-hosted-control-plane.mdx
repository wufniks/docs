...
![Self-Hosted Control Plane Architecture](/langgraph-platform/images/self-hosted-control-plane-architecture.png)
...
<Tip>
  If you would like to enable this on your LangSmith instance, please follow the [Self-Hosted Control Plane deployment guide](/langgraph-platform/deploy-self-hosted-control-plane).
</Tip>
