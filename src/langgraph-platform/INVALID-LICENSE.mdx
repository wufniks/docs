...
See the [local server](local-server) docs for more information.

#### For Managed LangGraph Platform

If you would like a fast managed environment, consider the [Cloud SaaS](cloud) deployment option. This requires no additional license key.
...
For more information on deployment options and their features, see the [Deployment Options](deployment-options) documentation.
