...
The default [MessagesState](/oss/graph-api#messagesstate) uses `AnyMessage`, which supports many message types but is too general for direct LLM exposure.
...
For more details, see the [low-level concepts guide](/oss/graph-api#state).
