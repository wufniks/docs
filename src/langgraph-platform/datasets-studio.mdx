...
sidebarTitle: Add node to dataset
---
This guide shows how to add examples to [LangSmith datasets](/langsmith/manage-datasets) from nodes in the thread log. This is useful to evaluate individual steps of the agent.
