...
---
[LangGraph SDK](/langgraph-platform/python-sdk) allows you to [stream outputs](https://langchain-ai.github.io/langgraph/concepts/streaming/) from the LangGraph API server.
...
|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| [`values`](#stream-graph-state)  | Stream the full graph state after each [super-step](/langgraph-platform/graph-rebuild#graphs).                                                                                            | `.stream()` / `.astream()` with [`stream_mode="values"`](https://langchain-ai.github.io/langgraph/how-tos/streaming/#stream-graph-state)  |
