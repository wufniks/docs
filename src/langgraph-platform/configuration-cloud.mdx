...
To create an assistant, use the [LangGraph SDK](sdk) `create` method. See the [Python](../cloud/reference/sdk/python-sdk_ref/#langgraph_sdk.client.AssistantsClient.create) and [JS](https://langchain-ai.github.io/langgraph/cloud/reference/sdk/js-ts-sdk_ref/#create) SDK reference docs for more information.
...
To confirm, click "Create assistant". This will take you to [LangGraph Studio](langgraph-studio) where you can test the assistant. If you go back to the "Assistants" tab in the deployment, you will see the newly created assistant in the table.
...
To edit the assistant, use the `update` method. This will create a new version of the assistant with the provided edits. See the [Python](../cloud/reference/sdk/python-sdk_ref/#langgraph_sdk.client.AssistantsClient.update) and [JS](https://langchain-ai.github.io/langgraph/cloud/reference/sdk/js-ts-sdk_ref/#update) SDK reference docs for more information.
