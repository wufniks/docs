...
* `onCustomEvent`: Called when a custom event is received. See the [streaming](/oss/langgraph/use-streaming#stream-custom-data) guide to learn how to stream custom events.
