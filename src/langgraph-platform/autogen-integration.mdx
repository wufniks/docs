...
* Enhanced features: Add [persistence](https://langchain-ai.github.io/langgraph/concepts/persistence/), [streaming](streaming), [short and long-term memory](https://langchain-ai.github.io/langgraph/concepts/memory/) and more to your AutoGen agents.
...
* Production deployment: Deploy your integrated solution to [LangGraph Platform](index) for scalable production use.
...
![Graph](images/autogen-output.png)
