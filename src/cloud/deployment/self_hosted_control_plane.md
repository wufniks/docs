...
---
Before deploying, review the [conceptual guide for the Self-Hosted Control Plane](../../concepts/langgraph_self_hosted_control_plane) deployment option.

<Info>
  **Important**
  The Self-Hosted Control Plane deployment option is currently in beta stage and requires an [Enterprise](../../concepts/plans) plan.
</Info>
...
1. As part of configuring your Self-Hosted LangSmith instance, you enable the `langgraphPlatform` option. This will provision a few key resources.
  1. `listener`: This is a service that listens to the [control plane](../../concepts/langgraph_control_plane) for changes to your deployments and creates/updates downstream CRDs.
  ...
  4. `host-backend`: This is the [control plane](../../concepts/langgraph_control_plane).
