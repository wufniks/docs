...
See a [usage example](/oss/how-to/document_loader_html).
...
See a [usage example](/oss/how-to/document_loader_pdf/#layout-analysis-and-extraction-of-text-from-images).
