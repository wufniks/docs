...
Learn more in the [example notebook](/oss/integrations/memory/cassandra_chat_message_history).
...
Learn more in the [example notebook](/oss/integrations/llm_caching#cassandra-caches) (scroll to the Cassandra section).
...
Learn more in the [example notebook](/oss/integrations/llm_caching#cassandra-caches) (scroll to the appropriate section).
