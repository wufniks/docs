...
import Firestore from "/snippets/javascript-integrations/examples/memory/firestore.mdx";
...
```
import FirestoreNested from "/snippets/javascript-integrations/examples/memory/firestore_nested.mdx";
