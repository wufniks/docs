...
<Info>
If you'd like to write your own chat model, see [this how-to](/oss/how-to/custom_chat). If you'd like to contribute an integration, see [Contributing integrations](/oss/contributing#add-a-new-integration).
</Info>
