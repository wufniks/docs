...
You may have noticed that the bot's knowledge is limited to what's in its training data. In the next part, we'll [add a web search tool](/oss/2-add-tools) to expand the bot's knowledge and make it more capable.
