...
You can also find Zep Open Source compatible [Retriever](/oss/integrations/retrievers/zep_memorystore), [Vector Store](/oss/integrations/vectorstores/zep) and [Memory](/oss/integrations/memory/zep_memory) examples
...
See a [Perpetual Memory Example here](/oss/integrations/memory/zep_cloud_chat_message_history).
...
See a [Memory RAG Example here](/oss/integrations/memory/zep_memory_cloud).
