...
<Tip>
To learn more about memory, see [Memory](/oss/memory). For information on implementing long-term memory that persists across sessions, see [Long-term memory](/oss/langchain/long-term-memory).
</Tip>
