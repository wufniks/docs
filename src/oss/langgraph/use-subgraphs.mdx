...
This guide explains the mechanics of using [subgraphs](/oss/concepts/subgraphs). A common application of subgraphs is to build [multi-agent](/oss/langchain/multi-agent) systems.
