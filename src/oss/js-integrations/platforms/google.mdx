...
Access Gemini models such as `gemini-1.5-pro` and `gemini-2.0-flex` through the [`ChatGoogleGenerativeAI`](/oss/integrations/chat/google_generativeai),
...
<Tip>
**Click [here](/oss/integrations/chat/google_generativeai) for the `@langchain/google-genai` specific integration docs**
</Tip>
